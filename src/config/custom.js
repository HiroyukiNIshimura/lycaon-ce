...
module.exports.custom = {
  ...
  plans: {
    free: {
      maxUser: 3,
      maxTeam: 1,
      maxSizePerThread: 10 * 1024 * 1024,
      maxFilePerThread: 5,
      maxSizePerWiki: 10 * 1024 * 1024,
      maxFilePerWiki: 5,
      maxSizePerVote: 10 * 1024 * 1024,
      maxFilePerVote: 5,
      maxQuota: 300 * 1024 * 1024,
      allowUseGit: false,
    },
    prime: {
      maxUser: 50,
