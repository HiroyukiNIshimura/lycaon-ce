...
module.exports = {
  ...
  datastores: {
    ...
    default: {
      ...
      url: 'postgresql://ユーザー:パスワード@サーバー:5433/lycaondb',
      // ssl: true,
    },
  },
  ...
  session: {
	...
	//TODO
    url: 'redis://サーバー:6379/0',
    // url: 'redis://user:password@example.com:6379/databasenumber',
    //--------------------------------------------------------------------------
  ...
  custom: {
    ...
    agenda: {
      mongoUrl: 'mongodb://サーバー:27017/lycaon-job-db',
    },
  },
};
