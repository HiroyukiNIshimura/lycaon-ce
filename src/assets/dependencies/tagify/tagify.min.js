/**
 * Tagify (v 4.1.2)- tags input component
 * By Yair Even-Or
...
(function ($) {
  ...
  !(function (t, e) {
    ...
    var c,
      p = {
            ...
            if (
              ...
              if (this.suggestedListItems.length)
                t &&
                  ...
                  !i(this.suggestedListItems[0].value, t) &&
                  this.suggestedListItems.unshift({ value: t });
              else {
                if (!t || !o || this.state.editing.scope)
                  return (
                    this.input.autocomplete.suggest.call(this), void this.dropdown.hide.call(this)
                  );
        ...
        render() {
          ...
          return (
            ...
            document.body.contains(this.DOM.dropdown) ||
              ...
              this.dropdown.position.call(this, s),
        ...
        highlightOption(t, e) {
          ...
          (i = this.suggestedListItems[this.getNodeIndex(t)]),
            ...
            e &&
              (t.parentNode.scrollTop = t.clientHeight + t.offsetTop - t.parentNode.clientHeight),
        ...
        selectOption(t) {
          ...
          if (!t)
            return (
              this.addTags(this.state.inputText, !0), void (s && this.dropdown.hide.call(this))
            );
          ...
          this.trigger('dropdown:select', { data: n, elm: t }),
            a && n
              ? (this.state.editing
                  ? this.onEditTagDone(null, d({ __isValid: !0 }, n))
                  : this['mix' == this.settings.mode ? 'addMixTags' : 'addTags']([n], i),
                setTimeout(() => {
                  this.DOM.input.focus(), this.toggleFocusClass(!0);
                }),
                s ? setTimeout(this.dropdown.hide.bind(this)) : this.dropdown.refilter.call(this))
              : this.dropdown.hide.call(this);
        },
        selectAll() {
          return (
        ...
        filterListItems(t, e) {
          var i,
            ...
            g =
              ((e = e || {}),
              (t =
                'select' == r.mode && this.value.length && this.value[0][r.tagTextProp] == t
                  ? ''
                  : t),
              []),
            c = r.whitelist,
          ...
          if (!t || !u.length)
            return (
              r.duplicates ? c : c.filter((t) => !this.isTagDuplicate(l(t) ? t.value : t))
            ).slice(0, p);
          function v(t, e) {
            return e
              .toLowerCase()
          ...
          for (o = d.caseSensitive ? '' + t : ('' + t).toLowerCase(); m < c.length; m++) {
            ...
            if (
              (d.fuzzySearch && !e.exact
                ? ((a = t.reduce((t, e) => t + ' ' + (i[e] || ''), '').toLowerCase()),
      ...
      m = {
        wrapper: (t, e) =>
          ...
          } data-placeholder="${e.placeholder || '&#8203;'}" aria-placeholder="${
            e.placeholder || ''
          }"\n                class="${
            e.classNames.input
        ...
        tag(t) {
          ...
          }">${t[this.settings.tagTextProp] || t.value}</span>\n            </div>\n        </tag>`;
        },
        dropdown(t) {
          var e = t.dropdown,
            i = 'manual' == e.position,
      ...
      callbacks: {
        onFocusBlur(t) {
          var e = t.target ? this.trim(t.target.textContent) : '',
            ...
            l =
              t.relatedTarget &&
              t.relatedTarget.classList.contains(i.classNames.tag) &&
            ...
            if (
              ...
              'blur' == s &&
                ...
                ('select' == this.settings.mode && e
                  ...
                  : e && !this.state.actions.selectOption && i.addTagOnBlur) && this.addTags(e, !0),
        ...
        onWindowKeyDown(t) {
          ...
          if (
            i.classList.contains(this.settings.classNames.tag) &&
              ...
              case 'Backspace':
                ...
                var i,
                  ...
                  d =
                    ...
                    (!r.anchorOffset && r.anchorNode.previousElementSibling),
                  h = a(this.DOM.input.innerHTML),
                  p = this.getTagElms();
                if ('edit' == this.settings.backspace && d)
                  return (
                    (i = 1 == r.anchorNode.nodeType ? null : r.anchorNode.previousElementSibling),
                    setTimeout(this.editTag.bind(this), 0, i),
                ...
                if (
                  ((l || d) && 1 == r.anchorNode.nodeType
                    ? (s = 0 == r.anchorOffset ? (l ? p[0] : null) : p[r.anchorOffset - 1])
                    : l
                    ? (s = r.anchorNode.nextElementSibling)
                    : d && (s = d),
                ...
                clearTimeout(c),
                  (c = setTimeout(() => {
                    ...
                    if (
                      ...
                      return (this.DOM.input.innerHTML = ''), (this.value.length = 0), !0;
                    this.value = [].map
                      .call(p, (t, e) => {
        ...
        onMixTagsInput(t) {
          ...
          if (
            ...
            u.childNodes.length && (m.insertNode(u), this.setRangeAtStartEnd(!1, u.lastChild)),
            p.length != c)
          )
            return (
              (this.value = [].map.call(this.getTagElms(), (t) => this.tagData(t))),
        ...
        onEditTagBlur(t) {
          if ((this.state.hasFocus || this.toggleFocusClass(), this.DOM.scope.contains(t))) {
            var e,
              ...
              r = this.validateTag({ [i.tagTextProp]: a });
            if (a)
              if (o) {
                if (
                  ((e = this.getWhitelistItem(a) || d({}, n, { [i.tagTextProp]: a, value: a })),
                  i.transformTag.call(this, e, n),
                  !0 !== (r = this.validateTag({ [i.tagTextProp]: e[i.tagTextProp] })))
                ) {
                  if (
                    (this.trigger('invalid', { data: e, tag: s, message: r }),
    ...
    function f(t, e) {
      return t
        ? t.previousElementSibling && t.previousElementSibling.classList.contains('tagify')
                    ...
                    if (((a = a || { cloneData: !0 }), i))
                      if (t.settings.isJQueryPlugin)
                        ...
                        try {
                          ...
                          if (
                            (((o = a.cloneData ? d({}, o) : o).tagify = this), s instanceof Object)
                          )
      ...
      (f.prototype = {
        ...
        applySettings(t, e) {
          ...
          if (
            ...
            'autoComplete' in e &&
              !l(e.autoComplete) &&
              ((i.autoComplete = u.autoComplete), (i.autoComplete.enabled = e.autoComplete)),
            'mix' == i.mode &&
          ...
          if (a) {
            if (!(o instanceof Object && 'editable' in o) || o.editable)
              return (
                ...
                this.tagData(t, { __originalData: d({}, o), __originalHTML: t.innerHTML }),
                ...
                (a.originalIsValid = h),
                this.trigger('edit:start', { tag: t, index: n, data: o, isValid: h }),
                this
              );
          } else
        ...
        setRangeAtStartEnd(t, e) {
          ...
          try {
            i.rangeCount >= 1 &&
              ['Start', 'End'].forEach((s) => i.getRangeAt(0)['set' + s](e, t || e.length));
          } catch (t) {
        ...
        input: {
          ...
          validate() {
            var t =
              !this.state.inputText || !0 === this.validateTag({ value: this.state.inputText });
          ...
          normalize(t) {
            ...
            return (
              (i = i.replace(/\s/g, ' ')), this.settings.trim && (i = i.replace(/^\s+/, '')), i
            );
          },
          autocomplete: {
            suggest(t) {
        ...
        tagData: (t, e, i) =>
          t
            ? (e && (t.__tagifyTagData = i ? e : d({}, t.__tagifyTagData || {}, e)),
              t.__tagifyTagData)
        ...
        isTagDuplicate(t, e) {
          ...
          return (
            'select' != s.mode &&
            this.value.reduce(
              (a, n) => (i(this.trim('' + t), n.value, e || s.dropdown.caseSensitive) ? a + 1 : a),
              0
            )
          );
        },
        ...
        getWhitelistItem(t, e, s) {
          ...
          return (
            ...
            a ||
              'value' != e ||
              'value' == n.tagTextProp ||
              (a = this.getWhitelistItem(t, n.tagTextProp, s)),
            a
          );
        },
        validateTag(t) {
        ...
        selectTag(t, e) {
          if (!this.settings.enforceWhitelist || this.isTagWhitelisted(e.value))
            return (
              this.input.set.call(this, e[this.settings.tagTextProp || 'value'], !0),
                ...
                : ('select' == a.mode && (e = !1),
                  ...
                  t.forEach((t) => {
                    ...
                    if (
                      ...
                      if (i) return;
                      d(o, this.getInvalidTagAttrs(t, t.__isValid), { __preInvalidData: r }),
        ...
        createTagElem(i, s) {
          i.__tagId = ([1e7] + -1e3 + -4e3 + -8e3 + -1e11).replace(/[018]/g, (t) =>
          ...
          return (
            (function (t) {
              for (
                var e, i = document.createNodeIterator(t, NodeFilter.SHOW_TEXT, null, !1);
                (e = i.nextNode());
        ...
        reCheckInvalidTags() {
          ...
          [].forEach.call(i, (t) => {
            ...
            i &&
              s &&
              ((e = e.__preInvalidData ? e.__preInvalidData : { value: e.value }),
              this.replaceTag(t, e));
          });
        },
        removeTags(t, e, i) {
            ...
            (function a(n) {
              n.childNodes.forEach((n) => {
                if (1 == n.nodeType) {
                  ...
                  'BR' != n.tagName ||
                  (n.parentNode != e.DOM.input && 1 != n.parentNode.childNodes.length)
