/**
 * Tagify (v 3.16.3)- tags input component
 * By Yair Even-Or
                  ...
                  if ('mix' != this.settings.mode && !this.settings.autoComplete.rightKey) {
                    try {
                      if (i.getAttribute('tagifySuggestionIdx')) {
                        var a = i ? i.textContent : this.suggestedListItems[0].value;
        ...
        highlightOption: function (t, e) {
          ...
          (i = this.suggestedListItems[this.getNodeIndex(t)]),
            ...
            this.settings.autoComplete &&
              ...
              'manual' != this.settings.dropdown.position && this.dropdown.position.call(this));
        },
        selectOption: function (t) {
          var e = this,
            i = this.settings.dropdown.closeOnSelect;
          if (!t)
            return this.addTags(this.input.value, !0), void (i && this.dropdown.hide.call(this));
        ...
        onKeydown: function (t) {
              ...
              case 'Backspace':
                ...
                setTimeout(function () {
                  if (
                    ...
                    2 == e.DOM.input.children.length && 'BR' == e.DOM.input.children[1].tagName)
                  )
          ...
          switch (t.key) {
            ...
            case 'ArrowRight':
              ...
              break;
            case 'Tab':
              if ((t.preventDefault(), !i || 'select' == this.settings.mode)) return !0;
            case 'Enter':
        ...
        onMixTagsInput: function (t) {
          ...
          if (
            ...
            if (
              ...
              (a = (i = e.toString().slice(0, e.endOffset)).split(h.pattern).length - 1),
              (s = i.match(h.pattern)) && (n = i.slice(i.lastIndexOf(s[s.length - 1]))),
              n)
            ) {
          ...
          setTimeout(function () {
            d.update({ withoutChangeEvent: !0 }),
              d.trigger('input', c({}, d.state.tag, { textContent: d.DOM.input.textContent })),
              d.state.tag && d.dropdown[o ? 'show' : 'hide'].call(d, d.state.tag.value);
          }, 10);
        },
              ...
              return e
                ...
                : void (t.target == this.DOM.input &&
                  ('mix' == i.mode && this.fixFirefoxLastTagNoCaret(), s > 500)
                    ? this.state.dropdown.visible
                      ? this.dropdown.hide.call(this)
                      : 0 === i.dropdown.enabled && 'mix' != i.mode && this.dropdown.show.call(this)
                    : 'select' == i.mode &&
                      !this.state.dropdown.visible &&
            ...
            n
              ? (this.settings.transformTag.call(this, a),
                !0 === (o = this.validateTag(a))
                  ? ((a = this.getWhitelistItemsByValue(s)[0] || a.__preInvalidData || {}),
    ...
    return (
      (f.prototype = {
        ...
        parseTemplate: function (t, e) {
          return (t = this.settings.templates[t] || t), this.parseHTML(l(t.apply(this, e)));
        },
        ...
        placeCaretAfterTag: function (t) {
          var e = t.nextSibling,
            ...
            s = i.getRangeAt(0);
          i.rangeCount &&
            (s.setStartAfter(e || t), s.setEndAfter(e || t), i.removeAllRanges(), i.addRange(s));
        },
        ...
        replaceTag: function (t, e) {
          (e && e.value) || (e = t.__tagifyTagData),
            e.__isValid && 1 != e.__isValid && c(e, this.getInvaildTagParams(e, e.__isValid));
        ...
        tagData: function (t, e) {
          return t
            ? (e && (t.__tagifyTagData = c({}, t.__tagifyTagData || {}, e)), t.__tagifyTagData)
        ...
        isTagDuplicate: function (t) {
          ...
          return (
            ...
            this.value.reduce(function (i, s) {
              return n(('' + t).trim(), s.value, e.dropdown.caseSensitive) ? i + 1 : i;
            }, 0)
          );
        },
        getTagIndexByValue: function (t) {
          ...
          return (
            this.getTagElms().forEach(function (s, a) {
              n(s.textContent.trim(), t, e.settings.dropdown.caseSensitive) && i.push(a);
            }),
            i
          );
        },
        ...
        getWhitelistItemsByValue: function (t) {
          return this.settings.whitelist.filter.call(this, function (e) {
            return 'value' in e && n(e.value || e, t, this.settings.dropdown.caseSensitive);
          });
        },
                ...
                : ('select' == n.mode && (e = !1),
                  ...
                  t.forEach(function (t) {
                    ...
                    if (
                      ...
                      if (s) return;
                      c(o, i.getInvaildTagParams(t, t.__isValid), { __preInvalidData: r }),
                    ...
                    i.appendTag(e),
                      t.__isValid && !0 === t.__isValid
                        ? (i.value.push(t),
                          i.update(),
                          i.trigger('add', { tag: e, index: i.value.length - 1, data: t }))
                        : (i.trigger('invalid', {
                            data: t,
