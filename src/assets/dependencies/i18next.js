              ...
              if (
                ...
                _this4.logger.warn(
                  'key "'
                    ...
                    .concat(codes.join(', '), '" won\'t get resolved as namespace "')
      ...
      },
      {
        ...
        value: function loadOne(name) {
          ...
          this.read(lng, ns, 'read', undefined, undefined, function (err, data) {
            ...
            if (!err && data)
              _this5.logger.log(
                ''.concat(prefix, 'loaded namespace ').concat(ns, ' for language ').concat(lng),
                data
              );
    ...
    _createClass(I18n, [
      ...
      },
      {
        ...
        value: function t() {
          ...
          return (
            this.translator &&
            (_this$translator = this.translator).translate.apply(_this$translator, arguments)
          );
        },
      },
      {
        ...
        value: function exists() {
          ...
          return (
            this.translator &&
            (_this$translator2 = this.translator).exists.apply(_this$translator2, arguments)
          );
        },
      },
      {
