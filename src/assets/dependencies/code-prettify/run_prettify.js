    ...
    var ca = (function () {
      ...
      (function () {
        function r(a) {
          ...
          for (var r = 0, A = !1, q = !1, I = 0, b = a.length; I < b; ++I) {
            ...
            if (t.ignoreCase) q = !0;
              ...
              /[a-z]/i.test(t.source.replace(/\\u[0-9a-f]{4}|\\x[0-9a-f]{2}|\\[^ux]/gi, ''))
            ) {
              A = !0;
              q = !1;
              break;
          ...
          for (
            var k = { b: 8, t: 9, n: 10, v: 11, f: 12, r: 13 }, u = [], I = 0, b = a.length;
            I < b;
            ++I
          ) {
            t = a[I];
        ...
        function v(a) {
          ...
          c.length &&
            f.push(['kwd', new RegExp('^(?:' + c.replace(/[\s,]+/g, '|') + ')\\b'), null]);
          d.push(['pln', /^\s+/, null, ' \r\n\t\u00a0']);
          c = '^.[^\\s\\w.$@\'"`/\\\\]*';
          a.regexLiterals && (c += '(?!s*/)');
          f.push(
        ...
        n(v({ keywords: M, hashComments: !0, cStyleComments: !0, verbatimStrings: !0, types: P }), [
          'cs',
        ]);
        n(v({ keywords: L, cStyleComments: !0 }), ['java']);
        n(v({ keywords: J, hashComments: !0, multiLineStrings: !0 }), ['bash', 'bsh', 'csh', 'sh']);
        n(v({ keywords: N, hashComments: !0, multiLineStrings: !0, tripleQuotedStrings: !0 }), [
          'cv',
          'py',
          'python',
        ]);
        ...
        n(v({ keywords: O, hashComments: !0, multiLineStrings: !0, regexLiterals: !0 }), [
          'rb',
          'ruby',
        ]);
