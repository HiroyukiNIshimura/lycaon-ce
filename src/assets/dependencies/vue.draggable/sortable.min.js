...
!(function (t) {
                ...
                ? ((b =
                  ...
                  M < p &&
                    ('auto' === g.overflowY ||
                      'scroll' === g.overflowY ||
                      'visible' === g.overflowY))
                : ((b = N < f && ('auto' === g.overflowX || 'scroll' === g.overflowX)),
                  M < p && ('auto' === g.overflowY || 'scroll' === g.overflowY))),
            ...
            !D ||
              ...
              (I[h].pid = setInterval(
                function () {
                  n &&
                    0 === this.layer &&
                    (mt.active._emulateDragOver(!0), mt.active._onTouchMove(k, !0));
  ...
  function mt(t, e) {
    ...
    (this.nativeDraggable = !e.forceFallback && a),
      ...
      e.supportPointer
        ...
        : (wt(t, 'mousedown', this._onTapStart), wt(t, 'touchstart', this._onTapStart)),
  ...
  function bt(t, e, o, n) {
    if (t) {
      ...
      do {
        if (
          (null != e &&
            (('>' === e[0] && t.parentNode === o && kt(t, e.substring(1))) || kt(t, e))) ||
          (n && t === o)
        )
          return t;
        if (t === o) break;
  ...
  function Pt(t) {
    for (var e = t.lastElementChild; e && (e === f || 'none' === e.style.display); )
  ...
  function Yt(t) {
    for (
      var e = t.tagName + t.className + t.src + t.href + t.textContent, o = e.length, n = 0;
      o--;
  ...
  return (
    ...
    (mt.prototype = {
      ...
      _computeIsAligned: function (t) {
        var e;
        if (
          (f && !C ? (z(), (e = st.elementFromPoint(t.clientX, t.clientY)), j()) : (e = t.target),
              ...
              if (h !== s) {
                if (((e = At(s, i.draggable)), 'function' == typeof d)) {
                  if (d.call(this, t, s, this))
                    return (
                      Ct(o, c, 'filter', s, n, n, e), void (r && t.cancelable && t.preventDefault())
                    );
                } else if (
                  d &&
      ...
      _prepareDragStart: function (t, e, o, n) {
        ...
        o &&
          ...
          (Z = l.group),
          (K = n),
          (p = { target: U, clientX: (e || t).clientX, clientY: (e || t).clientY }),
          ...
          y && this.nativeDraggable && ((this.options.touchStartThreshold = 4), (U.draggable = !0)),
          !l.delay || (this.nativeDraggable && (_ || dt))
            ...
            : (wt(s, 'mouseup', r._disableDelayedDrag),
              ...
              l.supportPointer && wt(s, 'pointermove', r._delayedDragTouchMoveHandler),
      ...
      _emulateDragOver: function (t) {
        if (k) {
          ...
          for (var e = st.elementFromPoint(k.clientX, k.clientY), o = e; e && e.shadowRoot; )
      ...
      _appendGhost: function () {
        if (!f) {
          ...
          if (S) {
            for (
              g = t;
              'static' === Dt(g, 'position') && 'none' === Dt(g, 'transform') && g !== st;
            ...
            g !== st.body && g !== st.documentElement
              ? (g === st && (g = H()), (e.top += g.scrollTop), (e.left += g.scrollLeft))
              : (g = H()),
              (m = Ft(g));
          }
        ...
        ((u = Ot(U)).draggable = !1),
          ...
          e
            ...
            : (_t(st, 'mouseup', o._onDrop),
              ...
              n && ((n.effectAllowed = 'move'), i.setData && i.setData.call(o, n, U)),
              wt(st, 'drop', o),
          ...
          if (
            ...
            s &&
              ...
              (c
                ? d || (t = !q.contains(U))
                : Q === this ||
                  ((this.lastPutMode = Z.checkPull(this, s, U, e)) && l.checkPut(this, s, U, e))))
          ) {
            var u = this._getDirection(e, r);
            if (((o = Lt(U)), t))
              return this._hideClone(), (V = q), G ? q.insertBefore(U, G) : q.appendChild(U), z(!0);
            var f = Pt(i);
            if (
              f &&
              ((I = e),
              ...
              if (r && r !== U && r.parentNode === i) {
                ...
                if (!1 !== S)
                  return (
                    ...
                    D && !y ? i.appendChild(U) : r.parentNode.insertBefore(U, D ? y : r),
          ...
          return (
            t &&
              ...
              s &&
                ...
                yt(U, a.ghostClass, !0)),
              Q !== h && h !== mt.active ? (Q = h) : h === mt.active && (Q = null),
              o && h._animate(o, U),
              r && n && h._animate(n, r)),
            ((r === U && !U.animated) || (r === i && !r.animated)) && ($ = null),
            a.dragoverBubble ||
              e.rootEl ||
              r === st ||
      ...
      _onDrop: function (t) {
        ...
        (rt = at = B = v = !1),
          ...
          this._offUpEvents(),
          t &&
            (J && (t.cancelable && t.preventDefault(), !o.dropBubble && t.stopPropagation()),
            ...
            U &&
              ...
              q !== V
                ...
                : U.nextSibling !== G &&
                  0 <= (n = At(U, o.draggable)) &&
                  (Ct(this, q, 'update', U, V, q, K, n, t), Ct(this, q, 'sort', U, V, q, K, n, t)),
              mt.active &&
                ((null != n && -1 !== n) || (n = K),
      ...
      toArray: function () {
        for (var t, e = [], o = this.el.children, n = 0, i = o.length, r = this.options; n < i; n++)
          bt((t = o[n]), r.draggable, this.el, !1) && e.push(t.getAttribute(r.dataIdAttr) || Yt(t));
        return e;
      },
      sort: function (t) {
        var n = {},
