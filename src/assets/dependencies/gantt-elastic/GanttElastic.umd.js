(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === 'object') exports['GanttElastic'] = factory(require('Vue'));
  else root['GanttElastic'] = factory(root['Vue']);
    ...
    /******/ [
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* unused harmony default export */ var _unused_webpack_default_export =
          _node_modules_vue_style_loader_index_js_node_modules_css_loader_index_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_vue_loader_lib_index_js_vue_loader_options_GanttElastic_vue_vue_type_style_index_0_lang_css___WEBPACK_IMPORTED_MODULE_0___default.a;
      ...
      /***/ function (module, __webpack_exports__, __webpack_require__) {
          ...
          methods: {
            ...
            howManyHoursFit(dayIndex) {
              ...
              for (let hours = 24; hours > 1; hours = Math.ceil(hours / 2)) {
                for (let formatName of formatNames) {
                  if (
                    (this.root.state.options.calendar.hour.maxWidths[formatName] +
                      additionalSpace) *
                      hours <=
                      fullCellWidth &&
                    hours > 1
            ...
            howManyDaysFit() {
              ...
              for (
                ...
                for (let formatName of formatNames) {
                  if (
                    (this.root.state.options.calendar.day.maxWidths[formatName] + additionalSpace) *
                      days <=
                      fullWidth &&
                    days > 1
                  ) {
            ...
            howManyMonthsFit() {
              ...
              if (monthsCount === 1) {
                for (let formatName of formatNames) {
                  if (
                    this.root.state.options.calendar.month.maxWidths[formatName] +
                      additionalSpace <=
                    fullWidth
                  ) {
                    return {
            ...
            generateMonths() {
              ...
              for (let monthIndex = 0; monthIndex < monthsCount.count; monthIndex++) {
                ...
                for (let formatName of formatNames) {
                  if (
                    this.root.state.options.calendar.month.maxWidths[formatName] + 2 <=
                    monthWidth
                  ) {
                ...
                let textWidth = 0;
                if (
                  typeof this.root.state.options.calendar.month.widths[monthIndex] !== 'undefined'
                ) {
        ...
        /* harmony default export */ var DependencyLinesvue_type_script_lang_js_ = {
          ...
          L ${startX + offset},${startY} `;
              if (isBefore) {
                points += `Q ${startX + offset + roundness},${startY} ${
                  startX + offset + roundness
                },${startY + roundness * yMultiplier}
            L ${startX + offset + roundness},${
                  startY + (distanceY * yMultiplier) / 2 - roundness * yMultiplier
                }
            Q ${startX + offset + roundness},${startY + (distanceY * yMultiplier) / 2} ${
                  startX + offset
                },${startY + (distanceY * yMultiplier) / 2}
            L ${startX - offset + distanceX},${startY + (distanceY * yMultiplier) / 2}
            Q ${startX - offset + distanceX - roundness},${
                  startY + (distanceY * yMultiplier) / 2
                } ${startX - offset + distanceX - roundness},${
                  startY + (distanceY * yMultiplier) / 2 + roundness * yMultiplier
                }
            L ${startX - offset + distanceX - roundness},${stopY - roundness * yMultiplier}
            Q ${startX - offset + distanceX - roundness},${stopY} ${
                  startX - offset + distanceX
                },${stopY}
            L ${stopX},${stopY}`;
              } else {
                points += `L ${startX + distanceX / 2 - roundness},${startY}
            Q ${startX + distanceX / 2},${startY} ${startX + distanceX / 2},${
                  startY + roundness * yMultiplier
                }
        ...
        const GanttElastic = {
          ...
          methods: {
            ...
            initializeStyle() {
              this.state.dynamicStyle = mergeDeep(
                {},
                prepareStyle(this.dynamicStyle),
                this.dynamicStyle
              );
            },
            ...
            pixelOffsetXToTime(pixelOffsetX) {
              ...
              return (
                offset * this.state.options.times.timePerPixel + this.state.options.times.firstTime
              );
            },
            ...
            globalOnResize() {
              ...
              if (
                ...
                let diffPercent =
                  100 - (diff / this.state.options.taskList.widthFromPercentage) * 100;
                if (diffPercent < 0) {
                  diffPercent = 0;
                }
          ...
          mounted() {
            this.state.options.clientWidth = this.$el.clientWidth;
            this.state.resizeObserver = new ResizeObserver_es['a' /* default */](
              (entries, observer) => {
                this.globalOnResize();
              }
            );
        ...
        /* concated harmony reexport mergeDeep */ __webpack_require__.d(
          __webpack_exports__,
          'mergeDeep',
          function () {
            return mergeDeep;
        ...
        /* concated harmony reexport mergeDeepReactive */ __webpack_require__.d(
          __webpack_exports__,
          'mergeDeepReactive',
          function () {
        ...
        /* concated harmony reexport notEqualDeep */ __webpack_require__.d(
          __webpack_exports__,
          'notEqualDeep',
          function () {
            return notEqualDeep;
        ...
        /* hot reload */
        if (false) {
          var GanttElastic_api;
        }
        GanttElastic_component.options.__file = 'src/GanttElastic.vue';
        /* harmony default export */ var src_GanttElastic = (__webpack_exports__['default'] =
          GanttElastic_component.exports);
