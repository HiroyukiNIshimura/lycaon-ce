...
!(function (t, e) {
      ...
      (function (t, e) {
        ...
        for (i = 0, n = t.length; i < n; ++i)
          (a = s),
            ...
            s &&
              ((o = t[i]),
              a && ((o.cp1x = un(o.cp1x, e.left, e.right)), (o.cp1y = un(o.cp1y, e.top, e.bottom))),
              r &&
                ((o.cp2x = un(o.cp2x, e.left, e.right)), (o.cp2y = un(o.cp2y, e.top, e.bottom))));
      })(t, i);
  }
  function gn(t, e, i, n) {
    ...
    for (let t = h, i = h; t <= d; ++t)
      (m = e[t % a]),
        m.skip ||
          ...
          null !== _ &&
            v() &&
            (g.push(vn({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)),
          (i = t),
          (x = p));
    return null !== _ && g.push(vn({ start: _, end: d, loop: u, count: a, style: f })), g;
  }
  function Mn(t, e) {
    const i = [],
      n = t.segments;
  ...
  function Gn(t) {
    return (
      Kn() && 'string' == typeof t ? (t = document.getElementById(t)) : t && t.length && (t = t[0]),
  ...
  class Jn {
    ...
    _initializePlatform(t, e) {
      return e.platform
        ? new e.platform()
        : !Kn() || ('undefined' != typeof OffscreenCanvas && t instanceof OffscreenCanvas)
        ? new Qe()
        : new di();
    }
    clear() {
    ...
    render() {
      ...
      !1 !== t.notifyPlugins('beforeRender', { cancelable: !0 }) &&
        (a.has(t) ? t.attached && !a.running(t) && a.start(t) : (t.draw(), Xn({ chart: t })));
    }
    draw() {
      const t = this;
      let e;
  ...
  function ro(t, e, i, n) {
    ...
    let c, h, d, u;
    for (c = i, h = i + n; c < h; ++c)
      (u = e[c]), (d = {}), (d[o.axis] = r || o.parse(a[c], c)), l.push(ao(u, d, s, c));
    return l;
  }
  function lo(t) {
  ...
  class co extends Li {
    ...
    parseObjectData(t, e, i, n) {
      ...
      let d, u, f, g;
      for (d = i, u = i + n; d < u; ++d)
        (g = e[d]), (f = {}), (f[o.axis] = o.parse(lt(g, l), d)), h.push(ao(lt(g, c), f, s, d));
      return h;
    }
    updateRangeFromParsed(t, e, i, n) {
    ...
    updateElements(t, e, i, n) {
      ...
      for (let c = e; c < e + i; ++c) {
        const e = t[c],
          ...
          b = (u.y =
            s || m ? r.getBasePixel() : r.getPixelForValue(l ? o.applyStack(r, i, l) : i.y, c));
  ...
  (fo.id = 'line'),
    ...
    (fo.overrides = { scales: { _index_: { type: 'category' }, _value_: { type: 'linear' } } });
  class go extends Li {
    constructor(t, e) {
  ...
  function wo(t, e) {
    const { x: i, y: n, startAngle: o, endAngle: s, pixelMargin: a } = e,
      ...
      l = e.innerRadius + a,
      { outerStart: c, outerEnd: h, innerStart: d, innerEnd: u } = yo(e, l, r, s - o),
      f = r - c,
      g = r - h,
      p = o + c / f,
      m = s - h / g,
  ...
  (Lo.id = 'line'),
    ...
    (Lo.descriptors = { _scriptable: !0, _indexable: (t) => 'borderDash' !== t && 'fill' !== t });
  class Io extends Ei {
    constructor(t) {
      super(),
        (this.options = void 0),
  ...
  function Vo(t, e, i, n) {
    ...
    return (
      n
        ? ((a = i), (t = Bo((t = (o = t) === (s = e) ? a : o === a ? s : o), i, e)))
        : (t = Bo(t, e, i)),
      t
    );
  }
  ...
  ($o.id = 'bar'),
    ...
    ($o.defaultRoutes = { backgroundColor: 'backgroundColor', borderColor: 'borderColor' });
      ...
      ? (function (t) {
          ...
          if (
            ...
            return (
              ...
              new Go({ x: c.x, y: c.y, radius: e.getDistanceFromCenterForValue(h) })
            );
  ...
  function is(t, e) {
    ...
    return (
      ...
      i.length ? new Lo({ points: i, options: { tension: 0 }, _loop: n, _fullLoop: n }) : null
    );
  }
  function ns(t, e, i) {
    let n = t[e].fill;
    ...
    buildTicks() {
      ...
      const o = (function (t, e) {
        ...
        for (
          ...
          (i.push({ value: o }),
          y <= o && k++,
          Tt(Math.round((y + k * M) * _) / _, o, b * (h ? ('' + o).length : 1)) && k++);
          k < w;
          ++k
        )
  ...
  (zs.id = 'logarithmic'),
    (zs.defaults = { ticks: { callback: Vi.formatters.logarithmic, major: { enabled: !0 } } });
  class js extends Ls {
    constructor(t) {
      super(t),
        (this.xCenter = void 0),
    ...
    drawBackground() {
      ...
      if (e) {
        ...
        n.save(),
          n.beginPath(),
          Hs(t, t.getDistanceFromCenterForValue(t._endValue), i, t.getLabels().length),
          n.closePath(),
          (n.fillStyle = e),
          n.fill(),
          n.restore();
