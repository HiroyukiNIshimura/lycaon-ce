...
!(function (f, e) {
  ...
  var e = Object.freeze({
    ...
    b = '$colorschemes';
  (f.defaults.global || f.defaults).plugins.colorschemes = {
  ...
  var r = {
    ...
    beforeUpdate: function (e, d, a) {
          ...
          return c.isArray(e)
            ...
            : 'string' == typeof e &&
              ...
              (a = e.match(/^(brewer\.\w+)([1-3])-(\d+)$/))
                ...
                : 'office.Office2007-2010-6' === e && (e = 'office.OfficeClassic6'),
              (r = d[(b = e.split('.'))[0]]))
            ? r[b[1]]
            : void 0;
        })(a.scheme),
      ...
      u &&
        ('function' == typeof G &&
          ((l = G((r = u.slice()))),
          c.isArray(l) && l.length ? (u = l) : c.isArray(r) && r.length && (u = r)),
        (o = u.length),
        e.config.data.datasets.forEach(function (f, d) {
          switch (((n = d % o), (t = u[s ? o - n - 1 : n]), (f[b] = {}), f.type || e.config.type)) {
            case 'line':
            case 'radar':
            case 'scatter':
              (void 0 === f.backgroundColor || B) &&
                ((f[b].backgroundColor = f.backgroundColor),
                (f.backgroundColor = c.color(t).alpha(i).rgbString())),
                (void 0 === f.borderColor || B) &&
                  ((f[b].borderColor = f.borderColor), (f.borderColor = t)),
                (void 0 === f.pointBackgroundColor || B) &&
                  ((f[b].pointBackgroundColor = f.pointBackgroundColor),
                  (f.pointBackgroundColor = c.color(t).alpha(i).rgbString())),
                (void 0 === f.pointBorderColor || B) &&
                  ((f[b].pointBorderColor = f.pointBorderColor), (f.pointBorderColor = t));
              break;
            case 'doughnut':
            case 'pie':
            case 'polarArea':
              (void 0 === f.backgroundColor || B) &&
                ...
                (f.backgroundColor = f.data.map(function (f, e) {
                  return (n = e % o), u[s ? o - n - 1 : n];
                })));
              break;
            default:
              (void 0 === f.backgroundColor || B) &&
                ((f[b].backgroundColor = f.backgroundColor), (f.backgroundColor = t));
          }
        }));
    },
    afterUpdate: function (f) {
      f.config.data.datasets.forEach(function (f) {
        f[b] &&
          (f[b].hasOwnProperty('backgroundColor') && (f.backgroundColor = f[b].backgroundColor),
          f[b].hasOwnProperty('borderColor') && (f.borderColor = f[b].borderColor),
          f[b].hasOwnProperty('pointBackgroundColor') &&
            (f.pointBackgroundColor = f[b].pointBackgroundColor),
          f[b].hasOwnProperty('pointBorderColor') && (f.pointBorderColor = f[b].pointBorderColor),
          delete f[b]);
      });
    },
  ...
  return f.register(r), (f.colorschemes = d), r;
});
