!(function (e, t) {
    ...
    if (
      ...
      (u = (function (e, t) {
        if (e) {
          ...
          return 'Map' === (u = 'Object' === u && e.constructor ? e.constructor.name : u) || 'Set' === u
            ? Array.from(e)
    ...
    return (
      ...
      (t.heading = function (e) {
        ...
        if (t) {
          var u = t[2].trim();
          return (
            /#$/.test(u) && ((e = I(u, '#')), (!this.options.pedantic && e && !/ $/.test(e)) || (u = e.trim())),
          ...
          if (t.header.length === t.align.length) {
            for (var u = t.align.length, n = 0; n < u; n++)
              /^ *-+: *$/.test(t.align[n])
                ...
                ? (t.align[n] = 'left')
                : (t.align[n] = null);
            for (u = t.cells.length, n = 0; n < u; n++) t.cells[n] = R(t.cells[n], t.header.length);
            return t;
          }
        }
      }),
        ...
        if (e) {
          for (
            var t,
              ...
              a = e[2],
              o = 1 < a.length,
              D = { type: 'list', raw: l, ordered: o, start: o ? +a.slice(0, -1) : '', loose: !1, items: [] },
            ...
            if (
              ...
              (!this.options.pedantic || this.options.smartLists
                ...
                : o == (1 === n[2].length)) &&
                ((u = c.slice(f + 1).join('\n').length), (D.raw = D.raw.substring(0, D.raw.length - u)), (f = p - 1)),
                (g = n);
            }
            (n = t.length),
              ...
              D.items.push({ type: 'list_item', raw: l, task: r, checked: i, loose: n, text: t });
          }
          return D;
        }
      }),
      (t.html = function (e) {
        ...
        if (e)
          return {
            ...
            text: this.options.sanitize ? (this.options.sanitizer ? this.options.sanitizer(e[0]) : q(e[0])) : e[0],
          };
      }),
      (t.def = function (e) {
        ...
        if (t) {
          ...
          return (
            ...
            O(
              ...
              {
                href:
                  (n = /^</.test(n) ? (this.options.pedantic && !/>$/.test(u) ? n.slice(1) : n.slice(1, -1)) : n) &&
                ...
                if (((i = i.length), n[3] || n[4])) l += i;
                  ...
                  if (!(0 < (l -= i)))
                    return (
                      (i = Math.min(i, i + l + a)),
                      Math.min(s, i) % 2
                        ? { type: 'em', raw: e.slice(0, s + n.index + i + 1), text: e.slice(1, s + n.index + i) }
                        : {
                            type: 'strong',
      ...
      (t.codespan = function (e) {
        ...
        if (t) {
          var u = t[2].replace(/\n/g, ' '),
            n = /[^ ]/.test(u),
            e = /^ /.test(u) && / $/.test(u);
          return n && e && (u = u.substring(1, u.length - 1)), (u = q(u, !0)), { type: 'codespan', raw: t[0], text: u };
        }
      }),
      (t.br = function (e) {
      ...
      (t.autolink = function (e, t) {
        ...
        if (e) {
          var u,
            t = '@' === e[2] ? 'mailto:' + (u = q(this.options.mangle ? t(e[1]) : e[1])) : (u = q(e[1]));
      ...
      (t.url = function (e, t) {
        ...
        if ((u = this.rules.inline.url.exec(e))) {
          if ('@' === u[2]) r = 'mailto:' + (n = q(this.options.mangle ? t(u[0]) : u[0]));
          else {
  ...
  (b.def = z(b.def).replace('label', b._label).replace('title', b._title).getRegex()),
    (b.bullet = /(?:[*+-]|\d{1,9}[.)])/),
    (b.item = /^( *)(bull) ?[^\n]*(?:\n(?! *bull ?)[^\n]*)*/),
    ...
    (b.paragraph = z(b._paragraph)
      ...
      .replace('tag', b._tag)
      .getRegex()),
    (b.blockquote = z(b.blockquote).replace('paragraph', b.paragraph).getRegex()),
    (b.normal = w({}, b)),
    (b.gfm = w({}, b.normal, {
      nptable:
  ...
  (y.punctuation = z(y.punctuation)
    ...
    (y.emStrong.lDelim = z(y.emStrong.lDelim).replace(/punct/g, y._punctuation).getRegex()),
    (y.emStrong.rDelimAst = z(y.emStrong.rDelimAst, 'g').replace(/punct/g, y._punctuation).getRegex()),
    (y.emStrong.rDelimUnd = z(y.emStrong.rDelimUnd, 'g').replace(/punct/g, y._punctuation).getRegex()),
    (y._escapes = /\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/g),
    (y._scheme = /[a-zA-Z][a-zA-Z0-9+.-]{1,31}/),
    (y._email =
      /[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/),
    (y.autolink = z(y.autolink).replace('scheme', y._scheme).replace('email', y._email).getRegex()),
    (y._attribute = /\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/),
    (y.tag = z(y.tag).replace('comment', y._comment).replace('attribute', y._attribute).getRegex()),
    (y._label = /(?:\[(?:\\.|[^\[\]\\])*\]|\\.|`[^`]*`|[^\[\]\\`])*?/),
    (y._href = /<(?:\\.|[^\n<>\\])+>|[^\s\x00-\x1f]*/),
    (y._title = /"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/),
    (y.link = z(y.link).replace('label', y._label).replace('href', y._href).replace('title', y._title).getRegex()),
    (y.reflink = z(y.reflink).replace('label', y._label).getRegex()),
    (y.reflinkSearch = z(y.reflinkSearch, 'g').replace('reflink', y.reflink).replace('nolink', y.nolink).getRegex()),
    (y.normal = w({}, y)),
    ...
    (y.gfm.url = z(y.gfm.url, 'i').replace('email', y.gfm._extended_email).getRegex()),
    (y.breaks = w({}, y.gfm, {
  ...
  var y = (function () {
      function u(e) {
        ...
        this.options.pedantic
          ...
          : this.options.gfm && ((e.block = P.gfm), this.options.breaks ? (e.inline = L.breaks) : (e.inline = L.gfm)),
      ...
      return (
        ...
        (n.blockTokens = function (r, t, e) {
          var u,
            ...
            o = this;
          for (
            void 0 === t && (t = []), void 0 === e && (e = !0), this.options.pedantic && (r = r.replace(/^ +$/gm, ''));
            r;
            ...
            if (
              ...
              if ((u = this.tokenizer.space(r))) (r = r.substring(u.raw.length)), u.type && t.push(u);
                ...
                (r = r.substring(u.raw.length)), (u.tokens = this.blockTokens(u.text, [], e)), t.push(u);
        ...
        (n.inlineTokens = function (r, t, e, u) {
          ...
          if (this.tokens.links) {
            ...
            if (0 < h.length)
              for (; null != (a = this.tokenizer.rules.inline.reflinkSearch.exec(c)); )
          ...
          for (; r; )
            if (
              ...
              if ((n = this.tokenizer.escape(r))) (r = r.substring(n.raw.length)), t.push(n);
                ...
                (r = r.substring(n.raw.length)),
                  'link' === n.type && (n.tokens = this.inlineTokens(n.text, [], !0, u)),
                  t.push(n);
              else if ((n = this.tokenizer.reflink(r, this.tokens.links)))
                (r = r.substring(n.raw.length)),
                  (i = t[t.length - 1]),
                  'link' === n.type
                    ? ((n.tokens = this.inlineTokens(n.text, [], !0, u)), t.push(n))
                    : i && 'text' === n.type && 'text' === i.type
                    ? ((i.raw += n.raw), (i.text += n.text))
                    : t.push(n);
              else if ((n = this.tokenizer.emStrong(r, c, D)))
                (r = r.substring(n.raw.length)), (n.tokens = this.inlineTokens(n.text, [], e, u)), t.push(n);
    ...
    b = (function () {
      ...
      return (
        (t.code = function (e, t, u) {
          var n = (t || '').match(/\S*/)[0];
          return (
            !this.options.highlight || (null != (t = this.options.highlight(e, n)) && t !== e && ((u = !0), (e = t))),
            (e = e.replace(/\n$/, '') + '\n'),
            n
              ? '<pre><code class="' +
        ...
        (t.link = function (e, t, u) {
          if (null === (e = V(this.options.sanitize, this.options.baseUrl, e))) return u;
          e = '<a href="' + H(e) + '"';
    ...
    te = (function () {
      ...
      return (
        (e.parse = function (e, t) {
          void 0 === t && (t = !0);
          for (var u, n, r, i, s, l, a, o, D, c, h, p, g, f, F, A, d = '', C = e.length, k = 0; k < C; k++)
            if (
              ((o = e[k]),
              !(
                this.options.extensions &&
                ...
                (!1 === (A = this.options.extensions.renderers[o.type].call(this, o)) &&
                  [
                    'space',
                    'hr',
                    'heading',
              ...
              switch (o.type) {
                ...
                case 'table':
                  for (l = D = '', r = o.header.length, u = 0; u < r; u++)
                    l += this.renderer.tablecell(this.parseInline(o.tokens.header[u]), {
                      header: !0,
                      align: o.align[u],
                    });
          ...
          for (var u, n, r = '', i = e.length, s = 0; s < i; s++)
            if (
              ...
              !(
                ...
                (!1 === (n = this.options.extensions.renderers[u.type].call(this, u)) &&
  ...
  function ae(e, u, n) {
          ...
          'code' === u.type &&
            ...
            setTimeout(function () {
              i(u.text, u.lang, function (e, t) {
                return e
                  ? s(e)
                  : (null != t && t !== u.text && ((u.text = t), (u.escaped = !0)), void (0 === --l && s()));
              });
            }, 0));
        }),
        void (0 === l && s())
    ...
    try {
      ...
      if (((e.message += '\nPlease report this to https://github.com/markedjs/marked.'), u.silent))
        return '<p>An error occurred:</p><pre>' + se(e.message + '', !0) + '</pre>';
      throw e;
    }
  }
  return (
              ...
              s[r.level] ? s[r.level].unshift(r.tokenizer) : (s[r.level] = [r.tokenizer]),
                r.start &&
                  ('block' === r.level
                    ...
                    : 'inline' === r.level &&
                      (s.startInline ? s.startInline.push(r.start) : (s.startInline = [r.start])));
            }
        ...
        !(function () {
          ...
          switch ((l(t), t.type)) {
            ...
            case 'list':
              ...
              break;
            default:
              ae.defaults.extensions && ae.defaults.extensions.childTokens && ae.defaults.extensions.childTokens[t.type]
                ? ae.defaults.extensions.childTokens[t.type].forEach(function (e) {
                    ae.walkTokens(t[e], l);
                  })
