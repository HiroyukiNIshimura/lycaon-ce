...
!(function (e, t) {
  ...
  return (function e() {
    ...
    if (((n.version = '2.3.0'), (n.removed = []), !t || !t.document || 9 !== t.document.nodeType))
    ...
    var pe = z,
      ...
      Ae = P,
      Te = null,
      xe = w({}, [].concat(q(E), q(D), q(R), q(N), q(M))),
      we = null,
      Se = w({}, [].concat(q(L), q(F), q(I), q(C))),
      ke = null,
      Ee = null,
      De = !0,
      Re = !0,
      ...
      Ze = !1,
      Je = null,
      Qe = o.createElement('form'),
      et = function (e) {
        (Je && Je === e) ||
          ((e && 'object' === (void 0 === e ? 'undefined' : G(e))) || (e = {}),
          (e = S(e)),
          (Te = 'ALLOWED_TAGS' in e ? w({}, e.ALLOWED_TAGS) : xe),
          ...
          (Ee = 'FORBID_ATTR' in e ? w({}, e.FORBID_ATTR) : {}),
          ...
          Pe &&
            ((Te = w({}, [].concat(q(M)))),
            (we = []),
            !0 === Pe.html && (w(Te, E), w(we, L)),
            !0 === Pe.svg && (w(Te, D), w(we, F), w(we, C)),
            !0 === Pe.svgFilters && (w(Te, R), w(we, F), w(we, C)),
            !0 === Pe.mathMl && (w(Te, N), w(we, I), w(we, C))),
          e.ADD_TAGS && (Te === xe && (Te = S(Te)), w(Te, e.ADD_TAGS)),
          e.ADD_ATTR && (we === Se && (we = S(we)), w(we, e.ADD_ATTR)),
          e.ADD_URI_SAFE_ATTR && w(qe, e.ADD_URI_SAFE_ATTR),
          He && (Te['#text'] = !0),
          Oe && w(Te, ['html', 'head', 'body']),
          Te.table && (w(Te, ['tbody']), delete ke.tbody),
          i && i(e),
          (Je = e));
      },
      tt = w({}, ['mi', 'mo', 'mn', 'ms', 'mtext']),
      nt = w({}, ['foreignobject', 'desc', 'title', 'annotation-xml']),
      rt = w({}, D);
    w(rt, R), w(rt, _);
    var ot = w({}, N);
    w(ot, O);
    var it = function (e) {
        ...
        if (e.namespaceURI === Ve)
          return t.namespaceURI === Xe ? 'math' === n : t.namespaceURI === Ye ? 'math' === n && nt[r] : Boolean(ot[n]);
      ...
      ct = function (e) {
        ...
        if (!t || !t.documentElement) {
          t = le.createDocument($e, 'template', null);
          try {
        ...
        return (
          ...
          $e === Xe ? ue.call(t, Oe ? 'html' : 'body')[0] : Oe ? t.documentElement : a
        );
      },
      st = function (e) {
      ...
      pt = function (e, t, n) {
        if (Ue && ('id' === t || 'name' === t) && (n in o || n in Qe)) return !1;
        if (Re && !Ee[t] && A(he, t));
        else if (De && A(ye, t));
        else {
      ...
      ht = function e(t) {
        var n = void 0,
          r = st(t);
        for (mt('beforeSanitizeShadowDOM', t, null); (n = r.nextNode()); )
          mt('uponSanitizeShadowNode', n, null), dt(n) || (n.content instanceof a && e(n.content), gt(n));
    ...
    return (
      (n.sanitize = function (e, o) {
        var i = void 0,
          ...
          u = void 0,
          f = void 0;
        if (((Ze = !e) && (e = '\x3c!--\x3e'), 'string' != typeof e && !ft(e))) {
        ...
        if ((Me || et(o), (n.removed = []), 'string' == typeof e && (je = !1), je));
        else if (e instanceof c)
          (1 === (l = (i = ct('\x3c!----\x3e')).ownerDocument.importNode(e, !0)).nodeType && 'BODY' === l.nodeName) ||
          'HTML' === l.nodeName
            ? (i = l)
            : i.appendChild(l);
        else {
          if (!Fe && !Ne && !Oe && -1 === e.indexOf('<')) return oe && ze ? oe.createHTML(e) : e;
          if (!(i = ct(e))) return Fe ? null : ie;
        }
        i && Le && at(i.firstChild);
        for (var m = st(je ? e : i); (s = m.nextNode()); )
          (3 === s.nodeType && s === u) || dt(s) || (s.content instanceof a && ht(s.content), gt(s), (u = s));
        if (((u = null), je)) return e;
        if (Fe) {
          if (Ie) for (f = se.call(i.ownerDocument); i.firstChild; ) f.appendChild(i.firstChild);
          else f = i;
          return Ce && (f = fe.call(r, f, !0)), f;
        }
