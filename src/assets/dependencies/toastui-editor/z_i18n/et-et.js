  ...
  return /******/ (function (modules) {
    ...
    /******/ [
      ...
      /* 1 */ /***/ function (module, __webpack_exports__, __webpack_require__) {
        ...
        _editor__WEBPACK_IMPORTED_MODULE_0___default.a.setLanguage(['et', 'et-ET'], {
          Markdown: 'Markdown',
          WYSIWYG: 'WYSIWYG',
          Write: 'Kirjutage',
          Preview: 'Eelvaade',
          ...
          Code: 'Kood',
          Line: 'Rida',
          Blockquote: 'Blokeeri pakkumine',
          'Unordered list': 'Tellimata loend',
          'Ordered list': 'Tellitud loend',
          Task: 'Ülesanne',
          Indent: 'Taane',
          Outdent: 'Outdent',
          ...
          'Add row': 'Lisa rida',
          'Add col': 'Lisage veerg',
          'Remove row': 'Eemaldage rida',
          'Remove col': 'Eemalda kol',
          'Align left': 'Joondage vasakule',
          'Align center': 'Joondage keskpunkt',
          'Align right': 'Joondage paremale',
          'Remove table': 'Eemalda laud',
          ...
          'Auto scroll disabled': 'Automaatne kerimine on keelatud',
