parasails.registerPage('admin-wiki-list', {
  //  ╦╔╗╔╦╔╦╗╦╔═╗╦    ╔═╗╔╦╗╔═╗╔╦╗╔═╗
  //  ║║║║║ ║ ║╠═╣║    ╚═╗ ║ ╠═╣ ║ ║╣
  //  ╩╝╚╝╩ ╩ ╩╩ ╩╩═╝  ╚═╝ ╩ ╩ ╩ ╩ ╚═╝
  data: {
  ...
  methods: {
    clickCallback: function (pageNum) {
      location.href = `/${this.organization.handleId}/admin/wikis/${pageNum}`;
    },
    ...
    submittedForm: async function () {
      ...
      this.syncing = true;
      location.href = `/${this.organization.handleId}/admin/wikis`;
    },
