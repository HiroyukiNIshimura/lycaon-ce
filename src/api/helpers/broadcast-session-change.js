module.exports = {
  friendlyName: 'broadcastSessionChange',
  ...
  fn: async function ({ req }) {
    ...
    let messageText = sails.__(
      `You have signed out or signed into a different session in another tab or window. Reload the page to refresh your session`
    );
